                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody style="text-align: center">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn-info btn-block"><a style="color: white;" href="#" onclick="loadpage('<?php echo base_url();?>index.php?adminController/new_registration_list/approved_details/<?php echo $reg['user_id']?>')"><i class="fa fa-eye"></i> View</a></button> 
                                    </td>
                                </tr>
                                <?php endforeach;?>
                            </tbody>
