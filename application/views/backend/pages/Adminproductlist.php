                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary" onclick="editinfo('<?php echo $pro['Id']?>','<?php echo $pro['Product_Name']?>','<?php echo $pro['Price']?>','<?php echo $pro['Status']?>')"><i class="fa fa-times"></i>Edit</button>
...
<script type="text/javascript">
    function editinfo(Editid,name,price,tatus){
      $('#EditId').val(Editid);
      $('#Name').val(name);
      $('#Price').val(price);
      $('#Status').val(tatus);
