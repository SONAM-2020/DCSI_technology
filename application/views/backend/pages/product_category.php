            ...
            <div class="widget-inner">
              <table id="table1" class="table table-bordered table-striped" class="display" style="width:100%">
                ...
                <tr>
                  ...
                  <td>
                    <button type="button" class="btn" onclick="editCategory('<?php echo $event['Id']?>','<?php echo $event['Category_Name']?>','<?php echo $event['Status']?>','<?php echo $event['Description'];?>')"><i class="fa fa-edit"></i>Edit</button> 
                    </td>
                  </tr>
                  <?php endforeach;?>
                </tbody>
...
<script type="text/javascript">
  ...
  function validateeditform(){
    ...
    function editCategory(id,name,status,discription,Img){
      $('#Name').val(name);
      $('#category').val(status);
