    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="alert alert-info">Clients Data</h3>
        </div>
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td></td>
              <td>
                <button type="button" class="btn btn-success btn-block" ><i class="fa fa-check"></i>Give Access</button>
                <button type="button" class="btn btn-success btn-block" ><i class="fa fa-home"></i>Company Data</button>
